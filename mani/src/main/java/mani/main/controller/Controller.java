...
public class Controller {
    ...
    public  String SentimentAnalyzerService()  throws TwitterException , IOException  {
      ...
      /* SentimentAnalyzerService  obj  = new SentimentAnalyzerService();
       int m=  obj.analyse("manikanta raju  kadari  is too  dangerous person ");
       System.out.println("sentiment-type:"+m);
       ...
       ConfigurationBuilder cb = new ConfigurationBuilder();
		...
		// status.getText();
		 SentimentAnalyzerService  obj  = new SentimentAnalyzerService();
		 int m=  obj.analyse(status.getText().trim()
         		.replaceAll("http.*?[\\S]+", "")  
         		.replaceAll("@[\\S]+", "")   
         		.replaceAll("#", "")
         		.replaceAll("[\\s]+", " "));
